...
_lr_productions = [
  ...
  ('start -> statements','start',1,'p_start','deqatn_parser.py',63),
  ('statements -> statement','statements',1,'p_statements','deqatn_parser.py',67),
  ('statements -> statement SEMICOLON statements','statements',3,'p_statements','deqatn_parser.py',68),
  ('statement -> NAME EQUALS expression','statement',3,'p_statement','deqatn_parser.py',76),
  ('statement -> NAME LPAREN arglist RPAREN EQUALS expression','statement',6,'p_statement','deqatn_parser.py',77),
  ('statement -> expression','statement',1,'p_statement','deqatn_parser.py',78),
  ('expression -> term','expression',1,'p_expression','deqatn_parser.py',106),
  ('expression -> expression PLUS term','expression',3,'p_expression','deqatn_parser.py',107),
  ('expression -> expression MINUS term','expression',3,'p_expression','deqatn_parser.py',108),
  ('term -> term TIMES factor','term',3,'p_term','deqatn_parser.py',118),
  ('term -> term DIVIDE factor','term',3,'p_term','deqatn_parser.py',119),
  ('term -> factor','term',1,'p_term','deqatn_parser.py',120),
  ('arglist -> expression','arglist',1,'p_arglist','deqatn_parser.py',129),
  ('arglist -> arglist COMMA expression','arglist',3,'p_arglist','deqatn_parser.py',130),
  ('factor -> NUMBER','factor',1,'p_factor_num','deqatn_parser.py',137),
  ('factor -> PLUS factor','factor',2,'p_factor_unary','deqatn_parser.py',142),
  ('factor -> MINUS factor','factor',2,'p_factor_unary','deqatn_parser.py',143),
  ('factor -> NAME','factor',1,'p_factor_name','deqatn_parser.py',150),
  ('factor -> NAME LPAREN arglist RPAREN','factor',4,'p_factor_function_call','deqatn_parser.py',160),
  ('factor -> factor POWER factor','factor',3,'p_factor_power','deqatn_parser.py',176),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','deqatn_parser.py',180),
]
